...
class AccountTotalsJSONImpl extends TwitterResponseImpl implements AccountTotals, Serializable {
	...
	public boolean equals(final Object o) {
		...
		return this.favorites == that.favorites && this.followers == that.followers && this.friends == that.friends
	...
	public String toString() {
		return "AccountTotalsJSONImpl{updates=" + this.updates + ", followers=" + this.followers + ", favorites="
				+ this.favorites + ", friends=" + this.friends + '}';
	}
}
