...
public final class OEmbedRequest implements Serializable {
	...
	public String toString() {
		return "OEmbedRequest{statusId=" + this.statusId + ", url='" + this.url + '\'' + ", maxWidth=" + this.maxWidth
				+ ", hideMedia=" + this.hideMedia + ", hideThread=" + this.hideThread + ", omitScript="
				+ this.omitScript + ", align=" + this.align + ", related="
				+ ((this.related == null) ? null : Arrays.asList(this.related)) + ", lang='" + this.lang + '\'' + '}';
	}

	public enum Align {
		LEFT("LEFT", 0), CENTER("CENTER", 1), RIGHT("RIGHT", 2), NONE("NONE", 3);
