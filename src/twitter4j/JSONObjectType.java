...
public final class JSONObjectType
{
    ...
    public enum Type
    {
        SENDER("SENDER", 0), 
        STATUS("STATUS", 1), 
        DIRECT_MESSAGE("DIRECT_MESSAGE", 2), 
        DELETE("DELETE", 3), 
        LIMIT("LIMIT", 4), 
        STALL_WARNING("STALL_WARNING", 5), 
        SCRUB_GEO("SCRUB_GEO", 6), 
        FRIENDS("FRIENDS", 7), 
        FAVORITE("FAVORITE", 8), 
        UNFAVORITE("UNFAVORITE", 9), 
        FOLLOW("FOLLOW", 10), 
        UNFOLLOW("UNFOLLOW", 11), 
        USER_LIST_MEMBER_ADDED("USER_LIST_MEMBER_ADDED", 12), 
        USER_LIST_MEMBER_DELETED("USER_LIST_MEMBER_DELETED", 13), 
        USER_LIST_SUBSCRIBED("USER_LIST_SUBSCRIBED", 14), 
        USER_LIST_UNSUBSCRIBED("USER_LIST_UNSUBSCRIBED", 15), 
        USER_LIST_CREATED("USER_LIST_CREATED", 16), 
        USER_LIST_UPDATED("USER_LIST_UPDATED", 17), 
        USER_LIST_DESTROYED("USER_LIST_DESTROYED", 18), 
        USER_UPDATE("USER_UPDATE", 19), 
        USER_DELETE("USER_DELETE", 20), 
        USER_SUSPEND("USER_SUSPEND", 21), 
        BLOCK("BLOCK", 22), 
        UNBLOCK("UNBLOCK", 23), 
        DISCONNECTION("DISCONNECTION", 24), 
        RETWEETED_RETWEET("RETWEETED_RETWEET", 25), 
        FAVORITED_RETWEET("FAVORITED_RETWEET", 26), 
        QUOTED_TWEET("QUOTED_TWEET", 27), 
        UNKNOWN("UNKNOWN", 28);
