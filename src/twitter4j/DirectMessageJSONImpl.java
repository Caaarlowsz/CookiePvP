...
final class DirectMessageJSONImpl extends TwitterResponseImpl implements DirectMessage, Serializable {
	...
	public boolean equals(final Object obj) {
		return obj != null
				&& (this == obj || (obj instanceof DirectMessage && ((DirectMessage) obj).getId() == this.id));
	}

	@Override
	public String toString() {
		return "DirectMessageJSONImpl{id=" + this.id + ", text='" + this.text + '\'' + ", sender_id=" + this.senderId
				+ ", recipient_id=" + this.recipientId + ", created_at=" + this.createdAt + ", userMentionEntities="
				+ ((this.userMentionEntities == null) ? null : Arrays.asList(this.userMentionEntities))
				+ ", urlEntities=" + ((this.urlEntities == null) ? null : Arrays.asList(this.urlEntities))
				+ ", hashtagEntities=" + ((this.hashtagEntities == null) ? null : Arrays.asList(this.hashtagEntities))
				+ ", sender_screen_name='" + this.senderScreenName + '\'' + ", recipient_screen_name='"
				+ this.recipientScreenName + '\'' + ", sender=" + this.sender + ", recipient=" + this.recipient
				+ ", userMentionEntities="
				+ ((this.userMentionEntities == null) ? null : Arrays.asList(this.userMentionEntities))
				+ ", urlEntities=" + ((this.urlEntities == null) ? null : Arrays.asList(this.urlEntities))
				+ ", hashtagEntities=" + ((this.hashtagEntities == null) ? null : Arrays.asList(this.hashtagEntities))
