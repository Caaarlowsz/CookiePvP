...
public class InvocationStatisticsCalculator implements InvocationStatistics {
	...
	public String toString() {
		...
		sb.append("calls=").append(this.getCallCount()).append(",").append("errors=").append(this.getErrorCount())
				.append(",").append("totalTime=").append(this.getTotalTime()).append(",").append("avgTime=")
				.append(this.getAverageTime());
		return sb.toString();
	}
}
