...
public interface ListsResources
{
    ...
    PagableResponseList<UserList> getUserListMemberships(final long p0, final int p1, final long p2) throws TwitterException;
    
    PagableResponseList<UserList> getUserListMemberships(final String p0, final long p1) throws TwitterException;
    
    PagableResponseList<UserList> getUserListMemberships(final String p0, final int p1, final long p2) throws TwitterException;
    
    PagableResponseList<UserList> getUserListMemberships(final String p0, final long p1, final boolean p2) throws TwitterException;
    
    PagableResponseList<UserList> getUserListMemberships(final String p0, final int p1, final long p2, final boolean p3) throws TwitterException;
    
    PagableResponseList<UserList> getUserListMemberships(final long p0, final long p1, final boolean p2) throws TwitterException;
    
    PagableResponseList<UserList> getUserListMemberships(final long p0, final int p1, final long p2, final boolean p3) throws TwitterException;
    
    PagableResponseList<User> getUserListSubscribers(final long p0, final long p1) throws TwitterException;
    
    PagableResponseList<User> getUserListSubscribers(final long p0, final int p1, final long p2) throws TwitterException;
    
    PagableResponseList<User> getUserListSubscribers(final long p0, final int p1, final long p2, final boolean p3) throws TwitterException;
    
    PagableResponseList<User> getUserListSubscribers(final long p0, final String p1, final long p2) throws TwitterException;
    
    PagableResponseList<User> getUserListSubscribers(final long p0, final String p1, final int p2, final long p3) throws TwitterException;
    
    PagableResponseList<User> getUserListSubscribers(final long p0, final String p1, final int p2, final long p3, final boolean p4) throws TwitterException;
    
    PagableResponseList<User> getUserListSubscribers(final String p0, final String p1, final long p2) throws TwitterException;
    
    PagableResponseList<User> getUserListSubscribers(final String p0, final String p1, final int p2, final long p3) throws TwitterException;
    
    PagableResponseList<User> getUserListSubscribers(final String p0, final String p1, final int p2, final long p3, final boolean p4) throws TwitterException;
    ...
    PagableResponseList<User> getUserListMembers(final long p0, final int p1, final long p2, final boolean p3) throws TwitterException;
    
    PagableResponseList<User> getUserListMembers(final long p0, final String p1, final long p2) throws TwitterException;
    
    PagableResponseList<User> getUserListMembers(final long p0, final String p1, final int p2, final long p3) throws TwitterException;
    
    PagableResponseList<User> getUserListMembers(final long p0, final String p1, final int p2, final long p3, final boolean p4) throws TwitterException;
    
    PagableResponseList<User> getUserListMembers(final String p0, final String p1, final long p2) throws TwitterException;
    
    PagableResponseList<User> getUserListMembers(final String p0, final String p1, final int p2, final long p3) throws TwitterException;
    
    PagableResponseList<User> getUserListMembers(final String p0, final String p1, final int p2, final long p3, final boolean p4) throws TwitterException;
    ...
    UserList updateUserList(final long p0, final String p1, final String p2, final boolean p3, final String p4) throws TwitterException;
    
    UserList updateUserList(final String p0, final String p1, final String p2, final boolean p3, final String p4) throws TwitterException;
    ...
    PagableResponseList<UserList> getUserListSubscriptions(final String p0, final int p1, final long p2) throws TwitterException;
    
    PagableResponseList<UserList> getUserListSubscriptions(final long p0, final long p1) throws TwitterException;
    
    PagableResponseList<UserList> getUserListSubscriptions(final long p0, final int p1, final long p2) throws TwitterException;
    
    PagableResponseList<UserList> getUserListsOwnerships(final String p0, final long p1) throws TwitterException;
    
    PagableResponseList<UserList> getUserListsOwnerships(final String p0, final int p1, final long p2) throws TwitterException;
    
    PagableResponseList<UserList> getUserListsOwnerships(final long p0, final long p1) throws TwitterException;
    
    PagableResponseList<UserList> getUserListsOwnerships(final long p0, final int p1, final long p2) throws TwitterException;
}
