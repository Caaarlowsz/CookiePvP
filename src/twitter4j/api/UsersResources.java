...
public interface UsersResources {
	...
	AccountSettings updateAccountSettings(final Integer p0, final Boolean p1, final String p2, final String p3,
			final String p4, final String p5) throws TwitterException;
	...
	User updateProfileColors(final String p0, final String p1, final String p2, final String p3, final String p4)
