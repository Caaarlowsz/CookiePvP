...
public interface FriendsFollowersResources
{
    ...
    PagableResponseList<User> getFriendsList(final long p0, final long p1, final int p2, final boolean p3, final boolean p4) throws TwitterException;
    
    PagableResponseList<User> getFriendsList(final String p0, final long p1, final int p2, final boolean p3, final boolean p4) throws TwitterException;
    ...
    PagableResponseList<User> getFollowersList(final long p0, final long p1, final int p2, final boolean p3, final boolean p4) throws TwitterException;
    
    PagableResponseList<User> getFollowersList(final String p0, final long p1, final int p2, final boolean p3, final boolean p4) throws TwitterException;
}
