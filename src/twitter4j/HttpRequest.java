...
public final class HttpRequest implements Serializable
{
    ...
    public HttpRequest(final RequestMethod method, final String url, final HttpParameter[] parameters, final Authorization authorization, final Map<String, String> requestHeaders) {
        this.method = method;
