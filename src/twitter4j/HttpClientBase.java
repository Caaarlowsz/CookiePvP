...
public abstract class HttpClientBase implements HttpClient, Serializable {
	...
	public HttpClientBase(final HttpClientConfiguration conf) {
		...
		this.requestHeaders.put("X-Twitter-Client-URL",
				"http://twitter4j.org/en/twitter4j-" + Version.getVersion() + ".xml");
	...
	@Override
	public final HttpResponse request(final HttpRequest req, final HttpResponseListener listener)
