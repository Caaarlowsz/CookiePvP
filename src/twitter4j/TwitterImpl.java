...
class TwitterImpl extends TwitterBaseImpl implements Twitter {
	...
	public ResponseList<Status> getMentionsTimeline() throws TwitterException {
		return this.factory.createStatusList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "statuses/mentions_timeline.json"));
	}
	...
	public ResponseList<Status> getHomeTimeline() throws TwitterException {
		return this.factory.createStatusList(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "statuses/home_timeline.json", this.INCLUDE_MY_RETWEET));
	}

	@Override
	public ResponseList<Status> getHomeTimeline(final Paging paging) throws TwitterException {
		return this.factory.createStatusList(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "statuses/home_timeline.json",
				this.mergeParameters(paging.asPostParameterArray(), new HttpParameter[] { this.INCLUDE_MY_RETWEET })));
	}

	@Override
	public ResponseList<Status> getRetweetsOfMe() throws TwitterException {
		return this.factory.createStatusList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "statuses/retweets_of_me.json"));
	}

	@Override
	public ResponseList<Status> getRetweetsOfMe(final Paging paging) throws TwitterException {
		return this.factory
				.createStatusList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "statuses/retweets_of_me.json",
						paging.asPostParameterArray()));
	}
	...
	public ResponseList<Status> getUserTimeline(final String screenName, final Paging paging) throws TwitterException {
		return this.factory.createStatusList(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "statuses/user_timeline.json",
				this.mergeParameters(
						new HttpParameter[] { new HttpParameter("screen_name", screenName), this.INCLUDE_MY_RETWEET },
						paging.asPostParameterArray())));
	}
	...
	public ResponseList<Status> getUserTimeline(final long userId, final Paging paging) throws TwitterException {
		return this.factory
				.createStatusList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "statuses/user_timeline.json",
						this.mergeParameters(
								new HttpParameter[] { new HttpParameter("user_id", userId), this.INCLUDE_MY_RETWEET },
								paging.asPostParameterArray())));
	}
	...
	public ResponseList<Status> getUserTimeline(final Paging paging) throws TwitterException {
		return this.factory.createStatusList(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "statuses/user_timeline.json",
				this.mergeParameters(new HttpParameter[] { this.INCLUDE_MY_RETWEET }, paging.asPostParameterArray())));
	}

	@Override
	public ResponseList<Status> getRetweets(final long statusId) throws TwitterException {
		return this.factory.createStatusList(this
				.get(String.valueOf(this.conf.getRestBaseURL()) + "statuses/retweets/" + statusId + ".json?count=100"));
	}
	...
	public IDs getRetweeterIds(final long statusId, final int count, final long cursor) throws TwitterException {
		return this.factory.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL())
				+ "statuses/retweeters/ids.json?id=" + statusId + "&cursor=" + cursor + "&count=" + count));
	}

	@Override
	public Status showStatus(final long id) throws TwitterException {
		return this.factory.createStatus(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "statuses/show/" + id + ".json", this.INCLUDE_MY_RETWEET));
	}

	@Override
	public Status destroyStatus(final long statusId) throws TwitterException {
		return this.factory.createStatus(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "statuses/destroy/" + statusId + ".json"));
	}

	@Override
	public Status updateStatus(final String status) throws TwitterException {
		return this.factory.createStatus(this.post(String.valueOf(this.conf.getRestBaseURL()) + "statuses/update.json",
				new HttpParameter("status", status)));
	}

	@Override
	public Status updateStatus(final StatusUpdate status) throws TwitterException {
		final String url = String.valueOf(this.conf.getRestBaseURL())
	...
	public Status retweetStatus(final long statusId) throws TwitterException {
		return this.factory.createStatus(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "statuses/retweet/" + statusId + ".json"));
	}

	@Override
	public OEmbed getOEmbed(final OEmbedRequest req) throws TwitterException {
		return this.factory.createOEmbed(this.get(String.valueOf(this.conf.getRestBaseURL()) + "statuses/oembed.json",
				req.asHttpParameterArray()));
	}

	@Override
	public ResponseList<Status> lookup(final long... ids) throws TwitterException {
		return this.factory.createStatusList(this
				.get(String.valueOf(this.conf.getRestBaseURL()) + "statuses/lookup.json?id=" + StringUtil.join(ids)));
	}

	@Override
	public UploadedMedia uploadMedia(final File image) throws TwitterException {
		this.checkFileValidity(image);
		return new UploadedMedia(this.post(String.valueOf(this.conf.getUploadBaseURL()) + "media/upload.json",
	...
	public QueryResult search(final Query query) throws TwitterException {
		if (query.nextPage() != null) {
			return this.factory.createQueryResult(
					this.get(String.valueOf(this.conf.getRestBaseURL()) + "search/tweets.json" + query.nextPage()),
					query);
		}
		return this.factory.createQueryResult(this
				.get(String.valueOf(this.conf.getRestBaseURL()) + "search/tweets.json", query.asHttpParameterArray()),
				query);
	}

	@Override
	public ResponseList<DirectMessage> getDirectMessages() throws TwitterException {
		return this.factory.createDirectMessageList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "direct_messages.json?full_text=true"));
	}

	@Override
	public ResponseList<DirectMessage> getDirectMessages(final Paging paging) throws TwitterException {
		return this.factory
				.createDirectMessageList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "direct_messages.json",
						this.mergeParameters(paging.asPostParameterArray(), new HttpParameter("full_text", true))));
	}

	@Override
	public ResponseList<DirectMessage> getSentDirectMessages() throws TwitterException {
		return this.factory.createDirectMessageList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "direct_messages/sent.json?full_text=true"));
	}

	@Override
	public ResponseList<DirectMessage> getSentDirectMessages(final Paging paging) throws TwitterException {
		return this.factory.createDirectMessageList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "direct_messages/sent.json",
						this.mergeParameters(paging.asPostParameterArray(), new HttpParameter("full_text", true))));
	}

	@Override
	public DirectMessage showDirectMessage(final long id) throws TwitterException {
		return this.factory.createDirectMessage(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "direct_messages/show.json?id=" + id + "&full_text=true"));
	}

	@Override
	public DirectMessage destroyDirectMessage(final long id) throws TwitterException {
		return this.factory.createDirectMessage(this.post(String.valueOf(this.conf.getRestBaseURL())
				+ "direct_messages/destroy.json?id=" + id + "&full_text=true"));
	}

	@Override
	public DirectMessage sendDirectMessage(final long userId, final String text) throws TwitterException {
		return this.factory
				.createDirectMessage(this.post(String.valueOf(this.conf.getRestBaseURL()) + "direct_messages/new.json",
	...
	public IDs getNoRetweetsFriendships() throws TwitterException {
		return this.factory
				.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL()) + "friendships/no_retweets/ids.json"));
	}

	@Override
	public IDs getFriendsIDs(final long cursor) throws TwitterException {
		return this.factory
				.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL()) + "friends/ids.json?cursor=" + cursor));
	}

	@Override
	public IDs getFriendsIDs(final long userId, final long cursor) throws TwitterException {
		return this.factory.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL()) + "friends/ids.json?user_id="
	...
	public IDs getFriendsIDs(final long userId, final long cursor, final int count) throws TwitterException {
		return this.factory.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL()) + "friends/ids.json?user_id="
				+ userId + "&cursor=" + cursor + "&count=" + count));
	}

	@Override
	public IDs getFriendsIDs(final String screenName, final long cursor) throws TwitterException {
		return this.factory.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL()) + "friends/ids.json",
				new HttpParameter("screen_name", screenName), new HttpParameter("cursor", cursor)));
	}
	...
	public IDs getFollowersIDs(final long cursor) throws TwitterException {
		return this.factory.createIDs(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "followers/ids.json?cursor=" + cursor));
	}

	@Override
	public IDs getFollowersIDs(final long userId, final long cursor) throws TwitterException {
		return this.factory.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL())
				+ "followers/ids.json?user_id=" + userId + "&cursor=" + cursor));
	}

	@Override
	public IDs getFollowersIDs(final long userId, final long cursor, final int count) throws TwitterException {
		return this.factory.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL())
				+ "followers/ids.json?user_id=" + userId + "&cursor=" + cursor + "&count=" + count));
	}

	@Override
	public IDs getFollowersIDs(final String screenName, final long cursor) throws TwitterException {
		return this.factory.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL()) + "followers/ids.json",
				new HttpParameter("screen_name", screenName), new HttpParameter("cursor", cursor)));
	}
	...
	public ResponseList<Friendship> lookupFriendships(final long... ids) throws TwitterException {
		return this.factory.createFriendshipList(this.get(String.valueOf(this.conf.getRestBaseURL())
				+ "friendships/lookup.json?user_id=" + StringUtil.join(ids)));
	}
	...
	public IDs getIncomingFriendships(final long cursor) throws TwitterException {
		return this.factory.createIDs(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "friendships/incoming.json?cursor=" + cursor));
	}

	@Override
	public IDs getOutgoingFriendships(final long cursor) throws TwitterException {
		return this.factory.createIDs(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "friendships/outgoing.json?cursor=" + cursor));
	}

	@Override
	public User createFriendship(final long userId) throws TwitterException {
		return this.factory.createUser(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "friendships/create.json?user_id=" + userId));
	}

	@Override
	public User createFriendship(final String screenName) throws TwitterException {
		return this.factory.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "friendships/create.json",
	...
	public User createFriendship(final long userId, final boolean follow) throws TwitterException {
		return this.factory.createUser(this.post(String.valueOf(this.conf.getRestBaseURL())
				+ "friendships/create.json?user_id=" + userId + "&follow=" + follow));
	}
	...
	public User destroyFriendship(final long userId) throws TwitterException {
		return this.factory.createUser(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "friendships/destroy.json?user_id=" + userId));
	}

	@Override
	public User destroyFriendship(final String screenName) throws TwitterException {
		return this.factory
				.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "friendships/destroy.json",
						new HttpParameter("screen_name", screenName)));
	}
	...
	public Relationship updateFriendship(final long userId, final boolean enableDeviceNotification,
		...
		return this.factory
				.createRelationship(this.post(String.valueOf(this.conf.getRestBaseURL()) + "friendships/update.json",
	...
	public Relationship updateFriendship(final String screenName, final boolean enableDeviceNotification,
			final boolean retweets) throws TwitterException {
		return this.factory.createRelationship(this.post(
				String.valueOf(this.conf.getRestBaseURL()) + "friendships/update.json",
	...
	public Relationship showFriendship(final long sourceId, final long targetId) throws TwitterException {
		return this.factory
				.createRelationship(this.get(String.valueOf(this.conf.getRestBaseURL()) + "friendships/show.json",
	...
	public Relationship showFriendship(final String sourceScreenName, final String targetScreenName)
		...
		return this.factory
				.createRelationship(this.get(String.valueOf(this.conf.getRestBaseURL()) + "friendships/show.json",
						HttpParameter.getParameterArray("source_screen_name", sourceScreenName, "target_screen_name",
								targetScreenName)));
	}
	...
	@Override
	public PagableResponseList<User> getFriendsList(final long userId, final long cursor, final int count)
			throws TwitterException {
		return this.factory.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL())
				+ "friends/list.json?user_id=" + userId + "&cursor=" + cursor + "&count=" + count));
	}
	...
	public PagableResponseList<User> getFriendsList(final String screenName, final long cursor, final int count)
			throws TwitterException {
		return this.factory
				.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "friends/list.json",
						new HttpParameter("screen_name", screenName), new HttpParameter("cursor", cursor),
						new HttpParameter("count", count)));
	}
	...
	public PagableResponseList<User> getFriendsList(final long userId, final long cursor, final int count,
		...
		return this.factory.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL())
				+ "friends/list.json?user_id=" + userId + "&cursor=" + cursor + "&count=" + count + "&skip_status="
				+ skipStatus + "&include_user_entities=" + includeUserEntities));
	}
	...
	public PagableResponseList<User> getFriendsList(final String screenName, final long cursor, final int count,
		...
		return this.factory
				.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "friends/list.json",
						new HttpParameter("screen_name", screenName), new HttpParameter("cursor", cursor),
						new HttpParameter("count", count), new HttpParameter("skip_status", skipStatus),
	...
	public PagableResponseList<User> getFollowersList(final long userId, final long cursor, final int count)
			throws TwitterException {
		return this.factory.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL())
				+ "followers/list.json?user_id=" + userId + "&cursor=" + cursor + "&count=" + count));
	}
	...
	public PagableResponseList<User> getFollowersList(final String screenName, final long cursor, final int count)
			throws TwitterException {
		return this.factory
				.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "followers/list.json",
						new HttpParameter("screen_name", screenName), new HttpParameter("cursor", cursor),
						new HttpParameter("count", count)));
	}
	...
	public PagableResponseList<User> getFollowersList(final long userId, final long cursor, final int count,
			final boolean skipStatus, final boolean includeUserEntities) throws TwitterException {
		return this.factory.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL())
				+ "followers/list.json?user_id=" + userId + "&cursor=" + cursor + "&count=" + count + "&skip_status="
				+ skipStatus + "&include_user_entities=" + includeUserEntities));
	}
	...
	public AccountSettings getAccountSettings() throws TwitterException {
		return this.factory
				.createAccountSettings(this.get(String.valueOf(this.conf.getRestBaseURL()) + "account/settings.json"));
	}
	...
	public AccountSettings updateAccountSettings(final Integer trend_locationWoeid, final Boolean sleep_timeEnabled,
		...
		return this.factory
				.createAccountSettings(this.post(String.valueOf(this.conf.getRestBaseURL()) + "account/settings.json",
						(HttpParameter[]) profile.toArray(new HttpParameter[profile.size()])));
	}
	...
	public User updateProfile(final String name, final String url, final String location, final String description)
		...
		return this.factory
				.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "account/update_profile.json",
						(HttpParameter[]) profile.toArray(new HttpParameter[profile.size()])));
	}
	...
	public User updateProfileBackgroundImage(final File image, final boolean tile) throws TwitterException {
		this.checkFileValidity(image);
		return this.factory.createUser(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "account/update_profile_background_image.json",
						new HttpParameter("image", image), new HttpParameter("tile", tile)));
	}
	...
	public User updateProfileBackgroundImage(final InputStream image, final boolean tile) throws TwitterException {
		return this.factory.createUser(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "account/update_profile_background_image.json",
						new HttpParameter("image", "image", image), new HttpParameter("tile", tile)));
	}
	...
	public User updateProfileColors(final String profileBackgroundColor, final String profileTextColor,
		...
		return this.factory
				.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "account/update_profile_colors.json",
						(HttpParameter[]) colors.toArray(new HttpParameter[colors.size()])));
	}
	...
	public User updateProfileImage(final File image) throws TwitterException {
		this.checkFileValidity(image);
		return this.factory
				.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "account/update_profile_image.json",
	...
	public PagableResponseList<User> getBlocksList(final long cursor) throws TwitterException {
		return this.factory.createPagableUserList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "blocks/list.json?cursor=" + cursor));
	}
	...
	public IDs getBlocksIDs(final long cursor) throws TwitterException {
		return this.factory
				.createIDs(this.get(String.valueOf(this.conf.getRestBaseURL()) + "blocks/ids.json?cursor=" + cursor));
	}

	@Override
	public User createBlock(final long userId) throws TwitterException {
		return this.factory.createUser(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "blocks/create.json?user_id=" + userId));
	}

	@Override
	public User createBlock(final String screenName) throws TwitterException {
		return this.factory.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "blocks/create.json",
				new HttpParameter("screen_name", screenName)));
	}
	...
	public User destroyBlock(final long userId) throws TwitterException {
		return this.factory.createUser(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "blocks/destroy.json?user_id=" + userId));
	}

	@Override
	public User destroyBlock(final String screenName) throws TwitterException {
		return this.factory.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "blocks/destroy.json",
				new HttpParameter("screen_name", screenName)));
	}
	...
	public PagableResponseList<User> getMutesList(final long cursor) throws TwitterException {
		return this.factory.createPagableUserList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "mutes/users/list.json?cursor=" + cursor));
	}

	@Override
	public IDs getMutesIDs(final long cursor) throws TwitterException {
		return this.factory.createIDs(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "mutes/users/ids.json?cursor=" + cursor));
	}

	@Override
	public User createMute(final long userId) throws TwitterException {
		return this.factory.createUser(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "mutes/users/create.json?user_id=" + userId));
	}

	@Override
	public User createMute(final String screenName) throws TwitterException {
		return this.factory.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "mutes/users/create.json",
				new HttpParameter("screen_name", screenName)));
	}
	...
	public User destroyMute(final long userId) throws TwitterException {
		return this.factory.createUser(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "mutes/users/destroy.json?user_id=" + userId));
	}

	@Override
	public User destroyMute(final String screenName) throws TwitterException {
		return this.factory
				.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "mutes/users/destroy.json",
						new HttpParameter("screen_name", screenName)));
	}

	@Override
	public ResponseList<User> lookupUsers(final long... ids) throws TwitterException {
		return this.factory.createUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/lookup.json",
	...
	public User showUser(final long userId) throws TwitterException {
		return this.factory
				.createUser(this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/show.json?user_id=" + userId));
	}

	@Override
	public User showUser(final String screenName) throws TwitterException {
		return this.factory.createUser(this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/show.json",
				new HttpParameter("screen_name", screenName)));
	}

	@Override
	public ResponseList<User> searchUsers(final String query, final int page) throws TwitterException {
		return this.factory.createUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/search.json",
	...
	public ResponseList<User> getContributees(final long userId) throws TwitterException {
		return this.factory.createUserList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/contributees.json?user_id=" + userId));
	}

	@Override
	public ResponseList<User> getContributees(final String screenName) throws TwitterException {
		return this.factory
				.createUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/contributees.json",
						new HttpParameter("screen_name", screenName)));
	}
	...
	public ResponseList<User> getContributors(final long userId) throws TwitterException {
		return this.factory.createUserList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/contributors.json?user_id=" + userId));
	}

	@Override
	public ResponseList<User> getContributors(final String screenName) throws TwitterException {
		return this.factory
				.createUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/contributors.json",
						new HttpParameter("screen_name", screenName)));
	}
	...
	public void updateProfileBanner(final File image) throws TwitterException {
		this.checkFileValidity(image);
		this.post(String.valueOf(this.conf.getRestBaseURL()) + "account/update_profile_banner.json",
	...
	public ResponseList<User> getUserSuggestions(final String categorySlug) throws TwitterException {
		HttpResponse res;
		try {
			res = this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/suggestions/"
					+ URLEncoder.encode(categorySlug, "UTF-8") + ".json");
	...
	public ResponseList<Category> getSuggestedUserCategories() throws TwitterException {
		return this.factory
				.createCategoryList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/suggestions.json"));
	}
	...
	public ResponseList<User> getMemberSuggestions(final String categorySlug) throws TwitterException {
		...
		try {
			res = this.get(String.valueOf(this.conf.getRestBaseURL()) + "users/suggestions/"
					+ URLEncoder.encode(categorySlug, "UTF-8") + "/members.json");
		} catch (UnsupportedEncodingException e) {
			throw new RuntimeException(e);
		}
	...
	public ResponseList<Status> getFavorites() throws TwitterException {
		return this.factory
				.createStatusList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "favorites/list.json"));
	}

	@Override
	public ResponseList<Status> getFavorites(final long userId) throws TwitterException {
		return this.factory.createStatusList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "favorites/list.json?user_id=" + userId));
	}
	...
	public ResponseList<Status> getFavorites(final Paging paging) throws TwitterException {
		return this.factory.createStatusList(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "favorites/list.json", paging.asPostParameterArray()));
	}

	@Override
	public ResponseList<Status> getFavorites(final long userId, final Paging paging) throws TwitterException {
		return this.factory.createStatusList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "favorites/list.json", this.mergeParameters(
						new HttpParameter[] { new HttpParameter("user_id", userId) }, paging.asPostParameterArray())));
	}
	...
	public ResponseList<Status> getFavorites(final String screenName, final Paging paging) throws TwitterException {
		return this.factory
				.createStatusList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "favorites/list.json",
						this.mergeParameters(new HttpParameter[] { new HttpParameter("screen_name", screenName) },
								paging.asPostParameterArray())));
	}
	...
	public Status destroyFavorite(final long id) throws TwitterException {
		return this.factory.createStatus(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "favorites/destroy.json?id=" + id));
	}

	@Override
	public Status createFavorite(final long id) throws TwitterException {
		return this.factory
				.createStatus(this.post(String.valueOf(this.conf.getRestBaseURL()) + "favorites/create.json?id=" + id));
	}
	...
	@Override
	public ResponseList<UserList> getUserLists(final String listOwnerScreenName, final boolean reverse)
			throws TwitterException {
		return this.factory.createUserListList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/list.json",
				new HttpParameter("screen_name", listOwnerScreenName), new HttpParameter("reverse", reverse)));
	}
	...
	public ResponseList<UserList> getUserLists(final long listOwnerUserId, final boolean reverse)
			throws TwitterException {
		return this.factory.createUserListList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/list.json",
				new HttpParameter("user_id", listOwnerUserId), new HttpParameter("reverse", reverse)));
	}

	@Override
	public ResponseList<Status> getUserListStatuses(final long listId, final Paging paging) throws TwitterException {
		return this.factory.createStatusList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/statuses.json", this.mergeParameters(
						paging.asPostParameterArray(Paging.SMCP, "count"), new HttpParameter("list_id", listId))));
	}
	...
	public ResponseList<Status> getUserListStatuses(final long ownerId, final String slug, final Paging paging)
			throws TwitterException {
		return this.factory
				.createStatusList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/statuses.json",
						this.mergeParameters(paging.asPostParameterArray(Paging.SMCP, "count"), new HttpParameter[] {
	...
	public ResponseList<Status> getUserListStatuses(final String ownerScreenName, final String slug,
		...
		return this.factory
				.createStatusList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/statuses.json",
						this.mergeParameters(paging.asPostParameterArray(Paging.SMCP, "count"),
	...
	public UserList destroyUserListMember(final long listId, final long userId) throws TwitterException {
		return this.factory
				.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/destroy.json",
	...
	public UserList destroyUserListMember(final long listId, final String screenName) throws TwitterException {
		return this.factory
				.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/destroy.json",
						new HttpParameter("list_id", listId), new HttpParameter("screen_name", screenName)));
	}
	...
	public UserList destroyUserListMembers(final long listId, final String[] screenNames) throws TwitterException {
		return this.factory.createAUserList(this.post(
				String.valueOf(this.conf.getRestBaseURL()) + "lists/members/destroy_all.json",
				new HttpParameter("list_id", listId), new HttpParameter("screen_name", StringUtil.join(screenNames))));
	}

	@Override
	public UserList destroyUserListMembers(final long listId, final long[] userIds) throws TwitterException {
		return this.factory.createAUserList(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/destroy_all.json",
						new HttpParameter("list_id", listId), new HttpParameter("user_id", StringUtil.join(userIds))));
	}

	@Override
	public UserList destroyUserListMembers(final String ownerScreenName, final String slug, final String[] screenNames)
			throws TwitterException {
		return this.factory.createAUserList(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/destroy_all.json",
						new HttpParameter("owner_screen_name", ownerScreenName), new HttpParameter("slug", slug),
	...
	public PagableResponseList<UserList> getUserListMemberships(final int count, final long cursor)
			throws TwitterException {
		return this.factory.createPagableUserListList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/memberships.json",
						new HttpParameter("cursor", cursor), new HttpParameter("count", count)));
	}
	...
	@Override
	public PagableResponseList<UserList> getUserListMemberships(final String listMemberScreenName, final int count,
	...
	public PagableResponseList<UserList> getUserListMemberships(final String listMemberScreenName, final int count,
		...
		return this.factory.createPagableUserListList(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "lists/memberships.json",
				new HttpParameter("screen_name", listMemberScreenName), new HttpParameter("count", count),
	...
	@Override
	public PagableResponseList<UserList> getUserListMemberships(final long listMemberId, final int count,
			final long cursor) throws TwitterException {
	...
	public PagableResponseList<UserList> getUserListMemberships(final long listMemberId, final int count,
		...
		return this.factory.createPagableUserListList(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "lists/memberships.json",
				new HttpParameter("user_id", listMemberId), new HttpParameter("count", count),
				new HttpParameter("cursor", cursor), new HttpParameter("filter_to_owned_lists", filterToOwnedLists)));
	}
	...
	@Override
	public PagableResponseList<User> getUserListSubscribers(final long listId, final int count, final long cursor)
			throws TwitterException {
	...
	@Override
	public PagableResponseList<User> getUserListSubscribers(final long listId, final int count, final long cursor,
			final boolean skipStatus) throws TwitterException {
		return this.factory
				.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/subscribers.json",
						new HttpParameter("list_id", listId), new HttpParameter("count", count),
						new HttpParameter("cursor", cursor), new HttpParameter("skip_status", skipStatus)));
	}

	@Override
	public PagableResponseList<User> getUserListSubscribers(final long ownerId, final String slug, final long cursor)
			throws TwitterException {
		return this.getUserListSubscribers(ownerId, slug, 20, cursor, false);
	}

	@Override
	public PagableResponseList<User> getUserListSubscribers(final long ownerId, final String slug, final int count,
			final long cursor) throws TwitterException {
	...
	@Override
	public PagableResponseList<User> getUserListSubscribers(final long ownerId, final String slug, final int count,
			final long cursor, final boolean skipStatus) throws TwitterException {
		return this.factory
				.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/subscribers.json",
						new HttpParameter("owner_id", ownerId), new HttpParameter("slug", slug),
						new HttpParameter("count", count), new HttpParameter("cursor", cursor),
	...
	@Override
	public PagableResponseList<User> getUserListSubscribers(final String ownerScreenName, final String slug,
			final int count, final long cursor, final boolean skipStatus) throws TwitterException {
		return this.factory
				.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/subscribers.json",
						new HttpParameter("owner_screen_name", ownerScreenName), new HttpParameter("slug", slug),
						new HttpParameter("count", count), new HttpParameter("cursor", cursor),
	...
	public UserList createUserListSubscription(final long listId) throws TwitterException {
		return this.factory
				.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/subscribers/create.json",
	...
	public User showUserListSubscription(final long listId, final long userId) throws TwitterException {
		return this.factory.createUser(this.get(String.valueOf(this.conf.getRestBaseURL())
	...
	public User showUserListSubscription(final String ownerScreenName, final String slug, final long userId)
			throws TwitterException {
		return this.factory
				.createUser(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/subscribers/show.json",
						new HttpParameter("owner_screen_name", ownerScreenName), new HttpParameter("slug", slug),
						new HttpParameter("user_id", userId)));
	}
	...
	public UserList destroyUserListSubscription(final long listId) throws TwitterException {
		return this.factory.createAUserList(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/subscribers/destroy.json",
						new HttpParameter("list_id", listId)));
	}
	...
	public UserList createUserListMembers(final long listId, final long... userIds) throws TwitterException {
		return this.factory
				.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/create_all.json",
						new HttpParameter("list_id", listId), new HttpParameter("user_id", StringUtil.join(userIds))));
	}
	...
	public UserList createUserListMembers(final long listId, final String... screenNames) throws TwitterException {
		return this.factory.createAUserList(this.post(
				String.valueOf(this.conf.getRestBaseURL()) + "lists/members/create_all.json",
				new HttpParameter("list_id", listId), new HttpParameter("screen_name", StringUtil.join(screenNames))));
	}
	...
	@Override
	public UserList createUserListMembers(final String ownerScreenName, final String slug, final String... screenNames)
			throws TwitterException {
		return this.factory
				.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/create_all.json",
						new HttpParameter("owner_screen_name", ownerScreenName), new HttpParameter("slug", slug),
	...
	public User showUserListMembership(final String ownerScreenName, final String slug, final long userId)
			throws TwitterException {
		return this.factory.createUser(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/show.json",
				new HttpParameter("owner_screen_name", ownerScreenName), new HttpParameter("slug", slug),
				new HttpParameter("user_id", userId)));
	}
	...
	@Override
	public PagableResponseList<User> getUserListMembers(final long listId, final int count, final long cursor)
			throws TwitterException {
	...
	public PagableResponseList<User> getUserListMembers(final long listId, final int count, final long cursor,
			final boolean skipStatus) throws TwitterException {
		return this.factory
				.createPagableUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/members.json",
						new HttpParameter("list_id", listId), new HttpParameter("count", count),
						new HttpParameter("cursor", cursor), new HttpParameter("skip_status", skipStatus)));
	}
	...
	@Override
	public PagableResponseList<User> getUserListMembers(final long ownerId, final String slug, final int count,
			final long cursor) throws TwitterException {
	...
	public UserList createUserListMember(final long listId, final long userId) throws TwitterException {
		return this.factory
				.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/create.json",
	...
	public UserList createUserListMember(final long ownerId, final String slug, final long userId)
		...
		return this.factory
				.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/create.json",
						new HttpParameter("user_id", userId), new HttpParameter("owner_id", ownerId),
						new HttpParameter("slug", slug)));
	}
	...
	public UserList createUserListMember(final String ownerScreenName, final String slug, final long userId)
		...
		return this.factory
				.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/members/create.json",
						new HttpParameter("user_id", userId), new HttpParameter("owner_screen_name", ownerScreenName),
						new HttpParameter("slug", slug)));
	}

	@Override
	public UserList destroyUserList(final long listId) throws TwitterException {
		return this.factory.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/destroy.json",
				new HttpParameter("list_id", listId)));
	}
	...
	public UserList updateUserList(final long ownerId, final String slug, final String newListName,
		...
		return this.updateUserList(newListName, isPublicList, newDescription, new HttpParameter("owner_id", ownerId),
				new HttpParameter("slug", slug));
	}
	...
	public UserList updateUserList(final String ownerScreenName, final String slug, final String newListName,
			final boolean isPublicList, final String newDescription) throws TwitterException {
		return this.updateUserList(newListName, isPublicList, newDescription,
				new HttpParameter("owner_screen_name", ownerScreenName), new HttpParameter("slug", slug));
	}

	private UserList updateUserList(final String newListName, final boolean isPublicList, final String newDescription,
			final HttpParameter... params) throws TwitterException {
		...
		return this.factory.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/update.json",
				(HttpParameter[]) httpParams.toArray(new HttpParameter[httpParams.size()])));
	}
	...
	public UserList createUserList(final String listName, final boolean isPublicList, final String description)
		...
		return this.factory.createAUserList(this.post(String.valueOf(this.conf.getRestBaseURL()) + "lists/create.json",
				(HttpParameter[]) httpParams.toArray(new HttpParameter[httpParams.size()])));
	}
	...
	public UserList showUserList(final long listId) throws TwitterException {
		return this.factory.createAUserList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/show.json?list_id=" + listId));
	}

	@Override
	public UserList showUserList(final long ownerId, final String slug) throws TwitterException {
		return this.factory.createAUserList(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "lists/show.json?owner_id=" + ownerId + "&slug=" + slug));
	}

	@Override
	public UserList showUserList(final String ownerScreenName, final String slug) throws TwitterException {
		return this.factory.createAUserList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/show.json",
				new HttpParameter("owner_screen_name", ownerScreenName), new HttpParameter("slug", slug)));
	}

	@Override
	public PagableResponseList<UserList> getUserListSubscriptions(final String listSubscriberScreenName,
			final long cursor) throws TwitterException {
	...
	public PagableResponseList<UserList> getUserListSubscriptions(final String listSubscriberScreenName,
			final int count, final long cursor) throws TwitterException {
		return this.factory.createPagableUserListList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/subscriptions.json",
						new HttpParameter("screen_name", listSubscriberScreenName), new HttpParameter("count", count),
						new HttpParameter("cursor", cursor)));
	}

	@Override
	public PagableResponseList<UserList> getUserListSubscriptions(final long listSubscriberId, final long cursor)
			throws TwitterException {
		return this.getUserListSubscriptions(listSubscriberId, 20, cursor);
	}

	@Override
	public PagableResponseList<UserList> getUserListSubscriptions(final long listSubscriberId, final int count,
			final long cursor) throws TwitterException {
		return this.factory.createPagableUserListList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/subscriptions.json",
						new HttpParameter("user_id", listSubscriberId), new HttpParameter("count", count),
						new HttpParameter("cursor", cursor)));
	}

	@Override
	public PagableResponseList<UserList> getUserListsOwnerships(final String listOwnerScreenName, final long cursor)
			throws TwitterException {
	...
	public PagableResponseList<UserList> getUserListsOwnerships(final String listOwnerScreenName, final int count,
			final long cursor) throws TwitterException {
		return this.factory.createPagableUserListList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/ownerships.json",
						new HttpParameter("screen_name", listOwnerScreenName), new HttpParameter("count", count),
						new HttpParameter("cursor", cursor)));
	}

	@Override
	public PagableResponseList<UserList> getUserListsOwnerships(final long listOwnerId, final long cursor)
			throws TwitterException {
	...
	public PagableResponseList<UserList> getUserListsOwnerships(final long listOwnerId, final int count,
		...
		return this.factory.createPagableUserListList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "lists/ownerships.json",
						new HttpParameter("user_id", listOwnerId), new HttpParameter("count", count),
						new HttpParameter("cursor", cursor)));
	}

	@Override
	public ResponseList<SavedSearch> getSavedSearches() throws TwitterException {
		return this.factory.createSavedSearchList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "saved_searches/list.json"));
	}

	@Override
	public SavedSearch showSavedSearch(final long id) throws TwitterException {
		return this.factory.createSavedSearch(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "saved_searches/show/" + id + ".json"));
	}

	@Override
	public SavedSearch createSavedSearch(final String query) throws TwitterException {
		return this.factory
				.createSavedSearch(this.post(String.valueOf(this.conf.getRestBaseURL()) + "saved_searches/create.json",
	...
	public SavedSearch destroySavedSearch(final long id) throws TwitterException {
		return this.factory.createSavedSearch(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "saved_searches/destroy/" + id + ".json"));
	}

	@Override
	public Place getGeoDetails(final String placeId) throws TwitterException {
		return this.factory
				.createPlace(this.get(String.valueOf(this.conf.getRestBaseURL()) + "geo/id/" + placeId + ".json"));
	}
	...
	public ResponseList<Place> reverseGeoCode(final GeoQuery query) throws TwitterException {
		try {
			return this.factory
					.createPlaceList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "geo/reverse_geocode.json",
	...
	public ResponseList<Place> searchPlaces(final GeoQuery query) throws TwitterException {
		return this.factory.createPlaceList(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "geo/search.json", query.asHttpParameterArray()));
	}

	@Override
	public ResponseList<Place> getSimilarPlaces(final GeoLocation location, final String name,
		...
		return this.factory
				.createPlaceList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "geo/similar_places.json",
						(HttpParameter[]) params.toArray(new HttpParameter[params.size()])));
	}

	@Override
	public Trends getPlaceTrends(final int woeid) throws TwitterException {
		return this.factory
				.createTrends(this.get(String.valueOf(this.conf.getRestBaseURL()) + "trends/place.json?id=" + woeid));
	}

	@Override
	public ResponseList<Location> getAvailableTrends() throws TwitterException {
		return this.factory
				.createLocationList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "trends/available.json"));
	}

	@Override
	public ResponseList<Location> getClosestTrends(final GeoLocation location) throws TwitterException {
		return this.factory.createLocationList(this.get(
				String.valueOf(this.conf.getRestBaseURL()) + "trends/closest.json",
	...
	public User reportSpam(final long userId) throws TwitterException {
		return this.factory.createUser(
				this.post(String.valueOf(this.conf.getRestBaseURL()) + "users/report_spam.json?user_id=" + userId));
	}

	@Override
	public User reportSpam(final String screenName) throws TwitterException {
		return this.factory.createUser(this.post(String.valueOf(this.conf.getRestBaseURL()) + "users/report_spam.json",
				new HttpParameter("screen_name", screenName)));
	}

	@Override
	public TwitterAPIConfiguration getAPIConfiguration() throws TwitterException {
		return this.factory.createTwitterAPIConfiguration(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "help/configuration.json"));
	}

	@Override
	public ResponseList<HelpResources.Language> getLanguages() throws TwitterException {
		return this.factory
				.createLanguageList(this.get(String.valueOf(this.conf.getRestBaseURL()) + "help/languages.json"));
	}

	@Override
	public String getPrivacyPolicy() throws TwitterException {
		try {
			return this.get(String.valueOf(this.conf.getRestBaseURL()) + "help/privacy.json").asJSONObject()
					.getString("privacy");
	...
	public String getTermsOfService() throws TwitterException {
		try {
			return this.get(String.valueOf(this.conf.getRestBaseURL()) + "help/tos.json").asJSONObject()
					.getString("tos");
		} catch (JSONException e) {
			throw new TwitterException(e);
		}
	...
	public Map<String, RateLimitStatus> getRateLimitStatus() throws TwitterException {
		return this.factory.createRateLimitStatuses(
				this.get(String.valueOf(this.conf.getRestBaseURL()) + "application/rate_limit_status.json"));
	}

	@Override
	public Map<String, RateLimitStatus> getRateLimitStatus(final String... resources) throws TwitterException {
		return this.factory.createRateLimitStatuses(this.get(String.valueOf(this.conf.getRestBaseURL())
				+ "application/rate_limit_status.json?resources=" + StringUtil.join(resources)));
	}
