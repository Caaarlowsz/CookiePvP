...
final class RateLimitStatusJSONImpl implements RateLimitStatus, Serializable
{
    ...
    public boolean equals(final Object o) {
        ...
        return this.limit == that.limit && this.remaining == that.remaining && this.resetTimeInSeconds == that.resetTimeInSeconds && this.secondsUntilReset == that.secondsUntilReset;
    }
