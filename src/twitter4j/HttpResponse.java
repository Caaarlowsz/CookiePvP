...
public abstract class HttpResponse {
		...
		if (this.json == null) {
			...
			try {
				...
				if (this.CONF.isPrettyDebugEnabled()) {
					...
					HttpResponse.logger
							.debug((this.responseAsString != null) ? this.responseAsString : this.json.toString());
				}
		...
		if (this.jsonArray == null) {
			...
			try {
				...
				if (this.CONF.isPrettyDebugEnabled()) {
					...
					HttpResponse.logger
							.debug((this.responseAsString != null) ? this.responseAsString : this.jsonArray.toString());
				}
			} catch (JSONException jsone) {
	...
	public String toString() {
		return "HttpResponse{statusCode=" + this.statusCode + ", responseAsString='" + this.responseAsString + '\''
				+ ", is=" + this.is + ", streamConsumed=" + this.streamConsumed + '}';
	}
}
