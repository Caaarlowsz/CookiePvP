...
public class TwitterException extends Exception implements TwitterResponse, HttpResponseCode {
	...
	public boolean exceededRateLimitation() {
		return (this.statusCode == 400 && this.getRateLimitStatus() != null) || this.statusCode == 420
				|| this.statusCode == 429;
	}
	...
	public String toString() {
		return String.valueOf(this.getMessage()) + (this.nested ? ""
				: ("\nRelevant discussions can be found on the Internet at:\n\thttp://www.google.co.jp/search?q="
						+ this.getExceptionDiagnosis().getStackLineHashAsHex()
						+ " or\n\thttp://www.google.co.jp/search?q="
						+ this.getExceptionDiagnosis().getLineNumberHashAsHex()))
				+ "\nTwitterException{" + (this.nested ? "" : ("exceptionCode=[" + this.getExceptionCode() + "], "))
				+ "statusCode=" + this.statusCode + ", message=" + this.errorMessage + ", code=" + this.errorCode
				+ ", retryAfter=" + this.getRetryAfter() + ", rateLimitStatus=" + this.getRateLimitStatus()
