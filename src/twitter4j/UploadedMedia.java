...
public final class UploadedMedia implements Serializable {
	...
	public boolean equals(final Object o) {
		...
		return this.imageWidth == that.imageWidth && this.imageHeight == that.imageHeight
				&& this.imageType == that.imageType && this.mediaId == that.mediaId && this.size == that.size;
	}
	...
	public String toString() {
		return "UploadedMedia{mediaId=" + this.mediaId + ", imageWidth=" + this.imageWidth + ", imageHeight="
				+ this.imageHeight + ", imageType='" + this.imageType + '\'' + ", size=" + this.size + '}';
	}
}
