...
public class CliqueInventory implements Listener
{
    ...
    public void clickartodoskits2(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§7\u27b3 §9§lTODOS OS KITS §8(p\u00e1g. 2)") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§7\u27b3 §a§lSEUS KITS")) {
                e.setCancelled(true);
                KitsMenu.inventory(p);
    ...
    public void clickarlojavips(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equals("§aQual {VIP} deseja?") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§7[§6Cookie§fNetwork§7] §f- §a§lVIP")) {
                e.setCancelled(true);
                p.closeInventory();
                p.sendMessage("§6§lCookie§f§lNetwork §7» §fAcesse nossa loja: §6§lmc-cookie.com.br");
                return;
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§7[§6Cookie§fNetwork§7] §f- §9§lMVP")) {
                e.setCancelled(true);
                p.closeInventory();
                p.sendMessage("§6§lCookie§f§lNetwork §7» §fAcesse nossa loja: §6§lmc-cookie.com.br");
                return;
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§7[§6Cookie§fNetwork§7] §f- §6§lPRO")) {
                e.setCancelled(true);
                p.closeInventory();
                p.sendMessage("§6§lCookie§f§lNetwork §7» §fAcesse nossa loja: §6§lmc-cookie.com.br");
            }
    ...
    public void clickarwarps(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§7\u27b3 §6§lWARPS") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
    ...
    public void clickarloja2(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§7\u27b3 §2§lLOJA DE KITS §8(p\u00e1g. 2)") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§7\u27b3 §a§lSEUS KITS")) {
                e.setCancelled(true);
                KitsMenu.inventory(p);
            ...
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§7[§6§Sumo§7] §f- §7Valor: §9§l15.000XP")) {
                ...
                if (cfStatus.getMoney(p) < 15000) {
                    p.sendMessage("§6§lCookie§f§lNetwork §7» §7Voc\u00ea n\u00e3o possui coins suficientes para comprar esse kit.");
                }
                else {
    ...
    public void clickarkits2(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§7\u27b3 §a§lSEUS KITS §8(p\u00e1g. 2)") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§7\u27b3 §9§lTODOS OS KITS")) {
                e.setCancelled(true);
                TodosKitsMenu.inventory(p);
    ...
    public void clickarkits(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§7\u27b3 §a§lSEUS KITS §8(p\u00e1g. 1)") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§7\u27b3 §9§lTODOS OS KITS")) {
                e.setCancelled(true);
                TodosKitsMenu.inventory(p);
