...
public class FriendsCommand implements CommandExecutor {
	public boolean onCommand(final CommandSender Sender, final Command Cmd, final String Label, final String[] Args) {
		...
		if (Cmd.getName().equalsIgnoreCase("friends")) {
			...
			p.sendMessage(" ");
			p.sendMessage(
					"§a§lFRIENDS? §fO sistema de friends \u00e9 muito pr\u00e1tico. Desenvolvido para um jogatina amig\u00e1vel e divertida, voc\u00ea pode utilizar os comandos abaixo para ter uma intera\u00e7\u00e3o maior com seus amigos!");
			p.sendMessage(" ");
