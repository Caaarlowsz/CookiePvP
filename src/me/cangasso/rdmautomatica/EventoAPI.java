...
public class EventoAPI implements Listener
{
    ...
    public static void SetarWarp(final Player Jogador, final String LocalDoEvento) {
        Configura\u00e7\u00e3o.getEvento().set(String.valueOf(LocalDoEvento) + ".Setado por", (Object)Jogador.getName());
        Configura\u00e7\u00e3o.getEvento().set(String.valueOf(LocalDoEvento) + ".X", (Object)Jogador.getLocation().getX());
        Configura\u00e7\u00e3o.getEvento().set(String.valueOf(LocalDoEvento) + ".Y", (Object)Jogador.getLocation().getY());
        Configura\u00e7\u00e3o.getEvento().set(String.valueOf(LocalDoEvento) + ".Z", (Object)Jogador.getLocation().getZ());
        Configura\u00e7\u00e3o.getEvento().set(String.valueOf(LocalDoEvento) + ".Pitch", (Object)Jogador.getLocation().getPitch());
        Configura\u00e7\u00e3o.getEvento().set(String.valueOf(LocalDoEvento) + ".Yaw", (Object)Jogador.getLocation().getYaw());
    ...
    public static void TeleportarWarp(final Player Jogador, final String LocalDoEvento) {
        ...
        final float pitch = (float)Configura\u00e7\u00e3o.getEvento().getDouble(String.valueOf(LocalDoEvento) + ".Pitch");
    ...
    public static long PegarCooldown(final Player Jogador) {
        final long Tempo = TimeUnit.MILLISECONDS.toSeconds(EventoAPI.Cooldown.get(Jogador) - System.currentTimeMillis());
    ...
    public void onRightClickPiston(final PlayerInteractEvent Evento) {
        final Player Jogador = Evento.getPlayer();
        if (Evento.getAction().equals((Object)Action.RIGHT_CLICK_BLOCK) && Evento.getClickedBlock().getType() != Material.STONE && EventoAPI.AntiBug.contains(Jogador)) {
