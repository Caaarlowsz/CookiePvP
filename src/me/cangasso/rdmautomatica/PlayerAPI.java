...
public class PlayerAPI
{
    ...
    private static ItemStack CriarItem(final Player player, final Material material, final int quantia, final short cor, final String[] lore, final String nome, final int slot, final int slotitem) {
    ...
    public static void IrParaPrimeiraBatalha(final Player Jogador1, final Player Jogador2) {
        ...
        new BukkitRunnable() {
            public void run() {
                Jogador1.sendMessage(ChatColor.GREEN + "§7Voc\u00ea \u00e9 o §e§lPRIMEIRO §7jogador do evento §a§lREI DA MESA");
                ...
                new BukkitRunnable() {
                    public void run() {
                        Jogador1.sendMessage(ChatColor.GREEN + "§7Voc\u00ea \u00e9 o §6§lSEGUNDO §7jogador do evento §a§lREI DA MESA");
                        ...
                        new BukkitRunnable() {
                            public void run() {
                                ...
                                for (int slot = 0; slot < Jogador1.getInventory().getSize(); ++slot) {
                                    CriarItem(Jogador1, Material.MUSHROOM_SOUP, 1, (short)0, new String[0], ChatColor.GOLD + "Sopa", slot, 0);
                                }
                                for (int slot = 0; slot < Jogador2.getInventory().getSize(); ++slot) {
                                    CriarItem(Jogador2, Material.MUSHROOM_SOUP, 1, (short)0, new String[0], ChatColor.GOLD + "Sopa", slot, 0);
                                }
                                CriarItem(Jogador1, Material.STONE_SWORD, 1, (short)0, new String[0], ChatColor.RED + "Rei da Mesa", 0, 0);
                                CriarItem(Jogador2, Material.STONE_SWORD, 1, (short)0, new String[0], ChatColor.RED + "Rei da Mesa", 0, 0);
                            }
    ...
    public static void IrParaProximaBatalha(final Player Jogador) {
        ...
        Tempo.mandarBroadcast(ChatColor.DARK_RED + ChatColor.BOLD.toString() + "RDM: " + ChatColor.GRAY + "§aEscolhendo o pr\u00f3ximo jogador" + ChatColor.GRAY + "§a...");
        ...
        new BukkitRunnable() {
            public void run() {
                ...
                Tempo.mandarBroadcast(ChatColor.DARK_RED + ChatColor.BOLD.toString() + "RDM: " + ChatColor.YELLOW + Jogador2.getName() + ChatColor.GRAY + " vs " + ChatColor.YELLOW + Jogador.getName() + ChatColor.GRAY + "!");
                ...
                new BukkitRunnable() {
                    public void run() {
                        ...
                        for (int slot = 0; slot < Jogador.getInventory().getSize(); ++slot) {
                            CriarItem(Jogador, Material.MUSHROOM_SOUP, 1, (short)0, new String[0], ChatColor.GOLD + "Sopa", slot, 0);
                        }
                        CriarItem(Jogador2, Material.STONE_SWORD, 1, (short)0, new String[0], ChatColor.RED + "Rei da Mesa", 0, 0);
                        CriarItem(Jogador, Material.STONE_SWORD, 1, (short)0, new String[0], ChatColor.RED + "Rei da Mesa", 0, 0);
                    }
                }.runTaskLater(Main.getPlugin(), 20L);
            }
        }.runTaskLaterAsynchronously(Main.getPlugin(), 20L);
    ...
    public static void AdicionarRDMCheio(final Player Jogador) {
        ...
        if (PlayerAPI.RDM7) {
            ...
            if (!Expulso.hasPermission("RDM.Full")) {
                ...
                Expulso.sendMessage(ChatColor.RED + "§c§l(!) §cMotivo: " + ChatColor.WHITE + "Um jogador com algum grupo VIP ocupou a sua vaga e infelizmente voc\u00ea teve que ser retirado!");
                Jogador.sendMessage(ChatColor.GREEN + "§aTeleporte foi conclu\u00eddo com sucesso!");
                Jogador.sendMessage(ChatColor.GREEN + "§7Voc\u00ea expulsou o jogador §c§l" + ChatColor.WHITE + Expulso.getName() + ChatColor.GREEN + " §7do evento e obteve a vaga dele.");
                Jogador.sendMessage(ChatColor.GREEN + "Agora voc\u00ea est\u00e1 participando do Evento!");
                EventoAPI.TeleportarWarp(Jogador, "Spawn");
                PlayerAPI.Participando.add(Jogador);
                EventoAPI.AntiBug.remove(Jogador);
                EventoAPI.Teleportando.remove(Jogador);
                Tempo.mandarBroadcast(ChatColor.DARK_RED + ChatColor.BOLD.toString() + " " + ChatColor.GRAY + "O jogador §6§l" + ChatColor.RED + Jogador.getName() + ChatColor.GRAY + " §7entrou no evento! " + ChatColor.WHITE + "§e§l(" + PlayerAPI.Participando.size() + "§e§l/30)" + ChatColor.GRAY + "§7!");
                PlayerAPI.RDM7 = true;
                Player[] onlinePlayers7;
                for (int length7 = (onlinePlayers7 = Bukkit.getOnlinePlayers()).length, n3 = 0; n3 < length7; ++n3) {
                    final Player Jogadores = onlinePlayers7[n3];
        ...
        if (PlayerAPI.RDM1 && PlayerAPI.RDM2 && PlayerAPI.RDM3 && PlayerAPI.RDM4 && PlayerAPI.RDM5 && PlayerAPI.RDM6 && PlayerAPI.RDM7 && PlayerAPI.RDM8 && PlayerAPI.RDM9 && PlayerAPI.RDM10 && PlayerAPI.RDM11 && PlayerAPI.RDM12 && PlayerAPI.RDM13 && PlayerAPI.RDM14 && PlayerAPI.RDM15 && PlayerAPI.RDM16 && PlayerAPI.RDM17 && PlayerAPI.RDM18 && PlayerAPI.RDM19 && PlayerAPI.RDM20 && PlayerAPI.RDM21 && PlayerAPI.RDM22 && PlayerAPI.RDM23 && PlayerAPI.RDM24 && PlayerAPI.RDM25 && PlayerAPI.RDM26 && PlayerAPI.RDM27 && PlayerAPI.RDM28 && PlayerAPI.RDM29 && PlayerAPI.RDM30) {
            ...
            new BukkitRunnable() {
                public void run() {
                    ...
                    if (cfGrupo.ChecarGrupo(Jogador, "Membro") || cfGrupo.ChecarGrupo(Jogador, "Light") || cfGrupo.ChecarGrupo(Jogador, "Mvp")) {
                        ...
                        GrupoAPI.expirar(Jogador, CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Dia) + 1, CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Mes), CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Ano), CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Hora), CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Minuto) + 1, CalendarioAPI.PegarCalendario(CalendarioAPI.Calendario.Segundo) + 1);
                        GrupoAPI.checarVip(Jogador);
                        Jogador.chat("/tag pro");
                        sScoreAPI.scoreboard(Jogador);
                        Jogador.setAllowFlight(false);
                        Jogador.sendMessage("§7Parab\u00e9ns! Voc\u00ea foi o §2§lVENCEDOR §7do evento e como recompensa recebeu o grupo §6§lPRO §7por §e§l1 §7dia.");
                        ...
                        Jogador.sendMessage("§cVoc\u00ea n\u00e3o recebeu um pr\u00eamio por ganhar pois o seu grupo \u00e9 maior do que a recompensa! §7§o(Mais vale um VIP eterno do que um PRO tempor\u00e1rio)");
                    }
