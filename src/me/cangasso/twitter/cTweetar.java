        ...
        if (cmd.getName().equalsIgnoreCase("tweetar")) {
            ...
            if (args.length == 1) {
                if (args[0].equalsIgnoreCase("principal")) {
                    p.sendMessage("§a§lVoc\u00ea escolheu Twittar em nossa conta principal. §7Utilize: §6§l/tweetar principal <tweet>");
                    return true;
                }
                if (args[0].equalsIgnoreCase("staff")) {
                    p.sendMessage("§a§lVoc\u00ea escolheu Twittar em nossa conta de atualiza\u00e7\u00f5es da equipe. §7Utilize: §6§l/tweetar staff §6<jogador> <Entrou | saiu | retirado | retorna | removido | rebaixado | afastou | afastado> <cargo> <Twitter do indiv\u00edduo>");
                    return true;
                }
                if (args[0].equalsIgnoreCase("bans")) {
                    p.sendMessage("§a§lVoc\u00ea escolheu Twittar em nossa conta respons\u00e1vel pelos banimentos. §7Utilize /tweetar bans <Tweet>");
                    return true;
                }
            }
            if (args.length >= 2) {
