	...
	public boolean onCommand(final CommandSender Sender, final Command Cmd, final String Label, final String[] Args) {
			...
			if (target == null) {
				...
				if (Args[1].equalsIgnoreCase("admin")) {
					if (cfGrupo.ChecarGrupo(p, "Dono") || cfGrupo.ChecarGrupo(p, "Admin")) {
						p.sendMessage(
								"§7Voc\u00ea alterou o grupo de §6§l" + targetoff.getName() + " §7para: §c§lADMIN");
						cfGrupo.setarGrupo(targetoff, "Admin");
						cfGrupo.salvarconfiguracao();
						return true;
					}
					p.sendMessage(
							"§4§l(!) §cVoc\u00ea deve possuir o grupo de DONO ou ADMIN para manipular estes grupos.");
				}
				if (Args[1].equalsIgnoreCase("gerente")) {
					if (cfGrupo.ChecarGrupo(p, "Dono") || cfGrupo.ChecarGrupo(p, "Admin")) {
						p.sendMessage(
								"§7Voc\u00ea alterou o grupo de §6§l" + targetoff.getName() + " §7para: §c§lGERENTE");
				...
				if (Args[1].equalsIgnoreCase("dono")) {
					if (cfGrupo.ChecarGrupo(p, "Dono")) {
						p.sendMessage(
								"§7Voc\u00ea alterou o grupo de §6§l" + targetoff.getName() + " §7para: §4§lDONO");
		...
		if (!(Sender instanceof Player)) {
			...
			if (target2 == null) {
				...
				if (Args[1].equalsIgnoreCase("mvp")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §9§lMVP");
				...
				if (Args[1].equalsIgnoreCase("pro")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §6§lPRO");
				...
				if (Args[1].equalsIgnoreCase("helper")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §d§lHELPER");
				...
				if (Args[1].equalsIgnoreCase("")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §d§lTRIAL");
				...
				if (Args[1].equalsIgnoreCase("modplus")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + targetoff2.getName() + " §7para: §5§lMODPLUS");
					cfGrupo.setarGrupo(targetoff2, "Mod+");
					cfGrupo.salvarconfiguracao();
					return true;
				}
			...
			if (target2 != null) {
				...
				if (Args[1].equalsIgnoreCase("helper")) {
					Sender.sendMessage(
							"§7Voc\u00ea alterou o grupo de §6§l" + target2.getName() + " §7para: §d§lHELPER");
