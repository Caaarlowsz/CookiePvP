            ...
            if (Args.length >= 2) {
                ...
                if (target != null) {
                    ...
                    for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
                        ...
                        if (cfGrupo.ChecarGrupo(s, "Dono") || cfGrupo.ChecarGrupo(s, "Gerente") || cfGrupo.ChecarGrupo(p, "Helper") || cfGrupo.ChecarGrupo(p, "Helper") || cfGrupo.ChecarGrupo(s, "Admin") || cfGrupo.ChecarGrupo(s, "Mod+") || cfGrupo.ChecarGrupo(s, "Mod") || cfGrupo.ChecarGrupo(s, "Trial") || cfGrupo.ChecarGrupo(s, "Youtuber+")) {
                            ...
                            s.sendMessage("§4§m->--------------------------<-");
                            ChatInterativo.Comando(s.getName(), "§fClique §b§l§nAQUI §fpara teleportar at\u00e9 o jogador.", "/tp " + target.getName(), "§eClique! §8(bot\u00e3o esquerdo)");
