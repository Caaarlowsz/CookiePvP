                ...
                if (sender instanceof Player) {
                    if (k == null) {
                        ...
                        if (arg.equalsIgnoreCase("vip")) {
                            p.sendMessage("§6§lCookie§f§lNetwork §7» §fVoc\u00ea aplicou o vip §a§lVIP §fpara o jogador: §a§l" + off.getName());
                            cfGrupo.setarGrupo(off, "Light");
                            cfGrupo.salvarconfiguracao();
                            return true;
                        }
                        if (arg.equalsIgnoreCase("mvp")) {
                            p.sendMessage("§6§lCookie§f§lNetwork §7» §fVoc\u00ea aplicou o vip §9§lMVP §fpara o jogador: §9§l" + off.getName());
                            cfGrupo.setarGrupo(off, "Mvp");
                            cfGrupo.salvarconfiguracao();
                            return true;
                        }
                        if (arg.equalsIgnoreCase("pro")) {
                            p.sendMessage("§6§lCookie§f§lNetwork §7» §fVoc\u00ea aplicou o vip §6§lPRO §fpara o jogador: §6§l" + off.getName());
                    ...
                    if (k != null) {
                        if (arg.equalsIgnoreCase("vip")) {
                            p.sendMessage("§6§lCookie§f§lNetwork §7» §fVoc\u00ea aplicou o vip §a§lVIP §fpara o jogador: §a§l" + k.getName());
                        ...
                        if (arg.equalsIgnoreCase("mvp")) {
                            p.sendMessage("§6§lCookie§f§lNetwork §7» §fVoc\u00ea aplicou o vip §9§lMVP §fpara o jogador: §9§l" + k.getName());
                        ...
                        if (arg.equalsIgnoreCase("pro")) {
                            p.sendMessage("§6§lCookie§f§lNetwork §7» §fVoc\u00ea aplicou o vip §6§lPRO §fpara o jogador: §6§l" + k.getName());
