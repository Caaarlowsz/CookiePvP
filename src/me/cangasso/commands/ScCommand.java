...
public class ScCommand implements Listener, CommandExecutor
{
    ...
    public void onChat(final AsyncPlayerChatEvent e) {
        ...
        for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
            ...
            if (this.isStaffChatting(p)) {
                e.setCancelled(true);
                if (cfGrupo.ChecarGrupo(online, "Dono") || cfGrupo.ChecarGrupo(online, "Gerente") || cfGrupo.ChecarGrupo(online, "Admin") || cfGrupo.ChecarGrupo(online, "Mod+") || cfGrupo.ChecarGrupo(online, "Mod") || cfGrupo.ChecarGrupo(online, "Trial") || cfGrupo.ChecarGrupo(online, "Youtuber+") || cfGrupo.ChecarGrupo(p, "Helper") || this.isStaffChatting(online)) {
    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String commandLabel, final String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("sc")) {
            if (!cfGrupo.ChecarGrupo(p, "Dono") && !cfGrupo.ChecarGrupo(p, "Gerente") && !cfGrupo.ChecarGrupo(p, "Builder") && !cfGrupo.ChecarGrupo(p, "Admin") && !cfGrupo.ChecarGrupo(p, "Mod+") && !cfGrupo.ChecarGrupo(p, "Mod") && !cfGrupo.ChecarGrupo(p, "Trial") && !cfGrupo.ChecarGrupo(p, "Youtuber+") && !cfGrupo.ChecarGrupo(p, "Helper")) {
