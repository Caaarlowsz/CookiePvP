    ...
    public boolean onCommand(final CommandSender Sender, final Command Cmd, final String Label, final String[] Args) {
        if (Cmd.getName().equalsIgnoreCase("chat")) {
            ...
            if (Args[0].equalsIgnoreCase("clear")) {
                ...
                Bukkit.getServer().broadcastMessage("  ");
                Bukkit.getServer().broadcastMessage("  ");
                Bukkit.getServer().broadcastMessage("§6§lCookie§f§lNetwork §7» §fO chat do servidor foi limpo por: §6§l" + p.getName());
            }
            else if (Args[0].equalsIgnoreCase("off")) {
                Bukkit.getServer().broadcastMessage("§6§lCookie§f§lNetwork §7» §fO chat do servidor foi §c§lDESATIVADO§f.");
                ChatCommand.pausado = true;
            }
            else if (Args[0].equalsIgnoreCase("on")) {
                Bukkit.getServer().broadcastMessage("§6§lCookie§f§lNetwork §7» §fO chat do servidor foi §a§lATIVADO§f.");
                ChatCommand.pausado = false;
            }
        }
        return true;
