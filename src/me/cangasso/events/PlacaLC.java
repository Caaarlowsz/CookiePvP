...
public class PlacaLC implements Listener
{
    ...
    public void inv(final PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && e.getClickedBlock() != null && (e.getClickedBlock().getType() == Material.WALL_SIGN || e.getClickedBlock().getType() == Material.SIGN_POST)) {
            ...
            if (lines.length > 0 && lines[0].equals(" ") && lines.length > 1 && lines[1].equals("§9§lCompletar!") && lines.length > 2 && lines[2].equals(" ") && lines.length > 3 && lines[3].equals("§7(F\u00e1cil)") && API.getWarp(p) == "Challenge") {
                ...
                p.getInventory().setItem(13, API.criarItem(p, Material.RED_MUSHROOM, "§c§lCogumelo!", new String[] { "" }, 64, (short)0));
                p.getInventory().setItem(14, API.criarItem(p, Material.BROWN_MUSHROOM, "§e§lCogumelo!", new String[] { "" }, 64, (short)0));
                p.getInventory().setItem(15, API.criarItem(p, Material.BOWL, "§9§lPote!", new String[] { "" }, 64, (short)0));
                sScoreAPI.scoreboard(p);
                p.sendMessage("§6§lCookie§f§lNetwork §7» §fVoc\u00ea ganhou §9§l500XP§f.");
            }
            if (lines.length > 0 && lines[0].equals(" ") && lines.length > 1 && lines[1].equals("§9§lCompletar!") && lines.length > 2 && lines[2].equals("") && lines.length > 3 && lines[3].equals("§7(M\u00e9dio)") && API.getWarp(p) == "Challenge") {
            ...
            if (lines.length > 0 && lines[0].equals(" ") && lines.length > 1 && lines[1].equals("§9§lCompletar!") && lines.length > 2 && lines[2].equals(" ") && lines.length > 3 && lines[3].equals("§7(Dif\u00edcil)") && API.getWarp(p) == "Challenge") {
                p.sendMessage("§6§lCookie§f§lNetwork §7» §fVoc\u00ea completou o §6§lLavaChallenge §fdif\u00edcil!");
                Bukkit.broadcastMessage(" ");
                Bukkit.broadcastMessage("§6§lCookie§f§lNetwork §7» §fO jogador §9§l" + p.getName() + " §fcompletou o n\u00edvel §c§ldif\u00edcil §fdo §6§lLavaChallenge§f!");
                Bukkit.broadcastMessage(" ");
