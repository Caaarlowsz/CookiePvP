...
public class PlacaVIP implements Listener
{
    ...
    public void inv(final PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && e.getClickedBlock() != null && (e.getClickedBlock().getType() == Material.WALL_SIGN || e.getClickedBlock().getType() == Material.SIGN_POST)) {
            ...
            if (lines.length > 0 && lines[0].equals(" ") && lines.length > 1 && lines[1].equals("  §a§lVIP ") && lines.length > 2 && lines[2].equals(" §7(Clique)") && lines.length > 3 && lines[3].equals(" ")) {
                Bukkit.broadcastMessage(" ");
                Bukkit.broadcastMessage("§fO jogador §5§l" + p.getName() + " §facaba de encontrar uma placa valendo VIP!");
                Bukkit.broadcastMessage(" ");
            ...
            if (lines.length > 0 && lines[0].equals(" ") && lines.length > 1 && lines[1].equals("  §9§lMVP") && lines.length > 2 && lines[2].equals(" §7(Clique)") && lines.length > 3 && lines[3].equals(" ")) {
            ...
            if (lines.length > 0 && lines[0].equals(" ") && lines.length > 1 && lines[1].equals("  §6§lPRO") && lines.length > 2 && lines[2].equals(" §7(Clique)") && lines.length > 3 && lines[3].equals(" ")) {
