...
public class eUtills implements Listener
{
    ...
    public void chat(final AsyncPlayerChatEvent e) {
        ...
        e.setFormat("§7(" + sScoreAPI.getRank(p) + "§7) " + p.getDisplayName() + "§7: §f" + e.getMessage().replace("%", "Porcento(s)"));
    ...
    public void onCommand(final PlayerCommandPreprocessEvent e) {
        final Player p = e.getPlayer();
        if (e.getMessage().contains(":") && !cfGrupo.ChecarGrupo(p, "Dono") && !cfGrupo.ChecarGrupo(p, "Mod+") && !cfGrupo.ChecarGrupo(p, "Mod") && !cfGrupo.ChecarGrupo(p, "Gerente") && !cfGrupo.ChecarGrupo(p, "Trial") && !cfGrupo.ChecarGrupo(p, "Helper") && !cfGrupo.ChecarGrupo(p, "Youtuber+") && !cfGrupo.ChecarGrupo(p, "Admin")) {
            e.setCancelled(true);
    ...
    public void motd(final ServerListPingEvent e) {
        e.setMotd("§6§lCookie§f§lNetwork §7» §a§lATUALIZADO! §f- §fServidor de §6§lKitPvP \n§6\u27a2 §fVenha conferir nossas §a§lNOVIDADES§f!");
    }
    ...
    @EventHandler
    public void quebrarArmor(final EntityDamageEvent e) {
    ...
    public void noInfos(final PlayerCommandPreprocessEvent e) {
        ...
        if (e.getMessage().toLowerCase().startsWith("/pl") || e.getMessage().toLowerCase().startsWith("/plugins") || e.getMessage().toLowerCase().startsWith("/bukkit:pl") || e.getMessage().toLowerCase().startsWith("/bukkit:plugins") || e.getMessage().toLowerCase().startsWith("/about") || e.getMessage().toLowerCase().startsWith("/ver") || e.getMessage().toLowerCase().startsWith("/bukkit:about") || e.getMessage().toLowerCase().startsWith("/bukkit:ver") || e.getMessage().toLowerCase().startsWith("/help") || e.getMessage().toLowerCase().startsWith("/?") || e.getMessage().toLowerCase().startsWith("/bukkit:?") || e.getMessage().toLowerCase().startsWith("/bukkit:help")) {
            p.sendMessage("§7Plugin de §6§lKITPVP§7. Vers\u00e3o: §3§l3.0§f - §7Para o §6§lCookie§f§lNetwork §f- §4§lBY: §7MoradorDeRua & Cangasso ");
            e.setCancelled(true);
        }
    }
    ...
    public void combatlog(final EntityDamageByEntityEvent e) {
        ...
        if (e.getDamager() instanceof Player && e.getEntity() instanceof Player) {
            ...
            if (API.getWarp(hitado) == "Arena") {
                ...
                API.mandarActionBar(bateu, String.valueOf(hitado.getDisplayName()) + " §f- §eKit: §7" + KitAPI.getKit(hitado));
